...
public OnPluginStart2()
{
	...
	if ((g_primaryOffset = FindSendPropInfo("CBaseCombatWeapon","m_flNextPrimaryAttack"))  == -1)
	{
		SetFailState("could not locate CBaseCombatWeapon:m_flNextPrimaryAttack");
	}
	if ((g_secondaryOffset = FindSendPropInfo("CBaseCombatWeapon","m_flNextSecondaryAttack"))  == -1)
	{
